/*    Implementa el TDA pila, la función main sólamente
      prueba las funciones de la implementación
*/
...
void main()
{
   ...
   if(isemptystack(pili))
      puts("Pila vacía. Paso 1 correcto.");
   pili = push(pili, 'a');
   printf("Tope: %c \n", top(pili));
   pili = pop(pili);
   if(isemptystack(pili))
      puts("Pila vacía. Paso 2 correcto.");
}
